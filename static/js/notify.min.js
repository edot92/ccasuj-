!(function (t) {
  ...
  var e =
    ...
    g = function (i, e) {
      ...
      r &&
        r.cssElem &&
        (window.console && console.warn(n + ": overwriting style '" + i + "'"),
        d[i].cssElem.remove()),
      (e.name = i),
      (d[i] = e)
      var s = ''
    ...
    v = function (i, e) {
      var n
      return (n = function () {}), (n.prototype = i), t.extend(!0, new n(), e)
    },
    C = function (i) {
      return t.extend(b, i)
    },
    ...
    D = function (t, i, e) {
      if (t === 'l' || t === 't') return 0
      if (t === 'c' || t === 'm') return e / 2 - i / 2
      if (t === 'r' || t === 'b') return e - i
  ...
  (i.prototype.setElementPosition = function () {
    ...
    for (
      ...
      {(R = z[b]),
          ...
          F && S(p, R, F)}
    if (
      ((y = Math.max(0, this.options.gap - (this.options.arrowShow ? o : 0))),
      S(p, k, y),
  ...
  (i.prototype.getPosition = function () {
    ...
    return (
      (t.length === 1 ||
          ((n = t[0]), e.call(l, n) >= 0 && ((o = t[1]), e.call(a, o) < 0)) ||
          ((r = t[0]), e.call(a, r) >= 0 && ((s = t[1]), e.call(l, s) < 0))) &&
  ...
  (i.prototype.getStyle = function (t) {
    var i
    if ((t || (t = this.options.style), t || (t = 'default'), (i = d[t]), !i))
  ...
  (i.prototype.run = function (i, e) {
    ...
    if (
      (t.isPlainObject(e)
        ...
        : t.type(e) === 'string' && (this.options.className = e),
      this.container && !i)
    )
